...
class SettingsState {
  ...
  const SettingsState({
    this.is24Hour = true, this.isDarkMode = false, this.soundEnabled = true,
    this.wallpaperSource = 'none', this.wallpaperUrl, this.wallpaperInterval = 0,
    this.layoutMode = 'auto', this.timerPresets = const [5,10,15],
    this.cloudServiceType = '坚果云', this.webdavUrl = 'https://dav.jianguoyun.com/dav/',
    this.webdavUsername = '', this.remoteFolder = '/灵动课堂数据/',
    this.autoSync = false, this.autoSyncInterval = 0,
    this.syncStrategy = 'bidirectional', this.conflictStrategy = 'remote',
    this.autoSave = true, this.autoSaveInterval = 30,
  });
  ...
  SettingsState copyWith({
    ...
    is24Hour: is24Hour ?? this.is24Hour, isDarkMode: isDarkMode ?? this.isDarkMode,
